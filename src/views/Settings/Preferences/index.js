...
import { GetUserSettings, PostSettings, UpdateSettings } from '../../../redux/User/actions'
...
const Preferences = ({ User, GetUserSettings, PostSettings, UpdateSettings }) => {
  useEffect(() => {
    if (User.token) GetUserSettings()
  }, [])

  const {
    Settings: { show_animated_background, dark_mode, offline_mode, push_messages },
  } = User
