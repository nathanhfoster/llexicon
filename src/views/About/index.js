    ...
    features: [
      {
        ...
        render: (
          <svg aria-hidden="true" focusable="false" viewBox="0 0 448 512" className="AboutFeatureImage">
            <path
              fill="currentColor"
            ...
            ></path>
            <path fill="#ecf0f1" d="M160 448h128a64 64 0 0 1-128 0z" className="fa-primary"></path>
          </svg>
        )
      },
      {
        ...
        render: (
          <svg aria-hidden="true" focusable="false" viewBox="0 0 640 512" className="AboutFeatureImage">
            <path
              fill="currentColor"
      ...
      },
      {
        ...
        render: (
          <svg aria-hidden="true" focusable="false" viewBox="0 0 320 512" className="AboutFeatureImage">
            <path
              fill="currentColor"
      ...
      },
      {
        ...
        render: (
          <svg aria-hidden="true" focusable="false" viewBox="0 0 512 512" className="AboutFeatureImage">
            <path
              fill="currentColor"
    ...
    features.map((feature, i) => {
      ...
      return (
        <Col key={i} md={3} sm={6} xs={12}>
          <Card className="AboutFeatureCard">
            <CardHeader className="AboutFeatureContainer">
              {typeof faIcon === "string" ? <i className={`AboutFeatureIcon ${faIcon}`} /> : render}
            </CardHeader>
            <CardBody className="AboutFeatureBodyContainer">
...
export default withRouter(reduxConnect(mapStateToProps, mapDispatchToProps)(About))
