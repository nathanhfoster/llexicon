...
const StarSearch = ({ isMobile, search, adminIsPending, isPending, SearchUserEntries }) => {
  const handleSearch = useCallback(searchValue => SearchUserEntries(searchValue), [])
  ...
  return (
    <InputGroup className='StarSearch' style={{ maxWidth: isMobile ? 'calc(100% - 52px)' : 360 }}>
      <InputGroupAddon addonType='prepend' className='TelescopeIconContainer Center'>
