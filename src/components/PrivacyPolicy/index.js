      ...
      <Container className="PrivacyPolicy Container">
        <Row>
          <Col xs={12}>
            ...
            <p>
              Nathan Foster will take all steps reasonably necessary to ensure
            ...
            <p>
              Nathan Foster may disclose your Personal Data in the good faith
              belief that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>
                To protect and defend the rights or property of Nathan Foster
              </li>
              <li>
...
export default reduxConnect(mapStateToProps, mapDispatchToProps)(PrivacyPolicy)
